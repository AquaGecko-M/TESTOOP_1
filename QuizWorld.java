...
public class QuizWorld extends World
{
    ...
    private void prepareQuiz()
    {
        ...
        GreenfootImage textImg = new GreenfootImage(questionString, 36, Color.WHITE, new Color(0,0,0,0));
    ...
    private void updateQuizTimerDisplay() {
        ...
        GreenfootImage textImg = new GreenfootImage(text, 24, Color.WHITE, new Color(0,0,0,0));
    ...
    public void checkAnswer(boolean wasCorrect) 
    {
        ...
        if (wasCorrect) {
            ...
            GreenfootImage textImg = new GreenfootImage(s, 48, Color.WHITE, new Color(0,0,0,0));
